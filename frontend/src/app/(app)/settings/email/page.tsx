        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input defaultValue="smtp.gmail.com" className="w-full rounded-lg border border-border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-text" />
            </div>
            <div>
              <label className="text-xs text-text-secondary">SMTP Port</label>
              <input defaultValue="587" type="number" className="w-full rounded-lg border border-border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-text" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-text-secondary">Username</label>
              <input defaultValue="" placeholder="email@hotel.com" className="w-full rounded-lg border border-border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-text" />
            </div>
            <div>
              <label className="text-xs text-text-secondary">Password</label>
              <input type="password" defaultValue="" placeholder="••••••••" className="w-full rounded-lg border border-border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-text" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-xs text-text-secondary">From Address</label>
              <input defaultValue="noreply@hotelpro.local" className="w-full rounded-lg border border-border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-text" />
            </div>
            <div>
              <label className="text-xs text-text-secondary">From Name</label>
              <input defaultValue="HotelPRO" className="w-full rounded-lg border border-border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-text" />
            </div>
          </div>
