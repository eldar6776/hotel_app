...
| `fnSobaStatus`, `sobe.ooo`, active `relgostsoba` | RULE-ROOM-002 | Room / RoomOperationalState | RoomStatusReadModel | SCENARIO-ROOM-STATUS-001 | SPEC_READY |
...
| `unesiPojedinacne`, `troskovi.zaklj` | RULE-EXPENSE-002 | ExpenseLedger | ExpenseTransferService | SCENARIO-EXPENSE-TRANSFER-001 | SPEC_READY |
